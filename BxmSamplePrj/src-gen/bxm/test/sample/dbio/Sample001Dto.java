 ...
 * @Description 
 */
@XmlType(propOrder={"rowId", "feduEmpNo", "feduEmpNm", "feduOccpNm", "feduMngrEmpNo", "feduHireDt", "feduPayAmt", "feduDeptNo"}, name="Sample001Dto")
@XmlRootElement(name="Sample001Dto")
@SuppressWarnings("all")
public class Sample001Dto  implements IOmmObject, Predictable, FieldInfo  {

	private static final long serialVersionUID = -1216754301L;
	...
	* Property set << rowId >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="Row Id", formatType="", format="", align="left", length=20, decimal=0, arrayReference="", fill="", encrypt="", validationRule="")
	...
	*******************************************************************************************************************************/
	...
	@Override
	public Sample001Dto clone(){
		try{
			Sample001Dto object= (Sample001Dto)super.clone();
	...
	public boolean equals(Object obj) {
		...
		final bxm.test.sample.dbio.Sample001Dto other= (bxm.test.sample.dbio.Sample001Dto)obj;
		if ( rowId == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.test.sample.dbio.Sample001Dto:\n");
		sb.append("\trowId: ");
