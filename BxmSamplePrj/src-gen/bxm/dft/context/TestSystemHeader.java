 ...
 */
@XmlType(propOrder={"msgLen", "guid", "trxCd", "sysCd", "chlType", "clientIp", "msgReqDttm", "msgResDttm", "trxBranchNo", "trxTerminalNo", "userId", "apprTrxYn", "apprUserId", "screenId", "langCd", "resCd", "edayYn", "domainId", "filler", "msgCd", "msgCnt", "msgs"}, name="TestSystemHeader")
@XmlRootElement(name="TestSystemHeader")
@SuppressWarnings("all")
public class TestSystemHeader  implements IOmmObject, Predictable, FieldInfo  {

	private static final long serialVersionUID = 1902221248L;
	...
	*******************************************************************************************************************************/
	...
	@Override
	public TestSystemHeader clone(){
		try{
			TestSystemHeader object= (TestSystemHeader)super.clone();
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.context.TestSystemHeader other= (bxm.dft.context.TestSystemHeader)obj;
		if ( msgLen == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.context.TestSystemHeader:\n");
		sb.append("\tmsgLen: ");
