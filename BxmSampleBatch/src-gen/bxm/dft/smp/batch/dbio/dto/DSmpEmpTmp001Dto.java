...
/**
 * @Description 샘플 직원정보 입력 IO
 */
@XmlType(propOrder={"feduEmpNo", "feduEmpNm", "feduOccpNm", "feduMngrEmpNo", "feduHireDt", "feduPayAmt", "feduDeptNo"}, name="DSmpEmpTmp001Dto")
...
public class DSmpEmpTmp001Dto  implements IOmmObject, Predictable, FieldInfo  {
	...
	@XmlTransient
	public static final String OMM_DESCRIPTION = "샘플 직원정보 입력 IO";
	...
	*******************************************************************************************************************************/
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.batch.dbio.dto.DSmpEmpTmp001Dto other= (bxm.dft.smp.batch.dbio.dto.DSmpEmpTmp001Dto)obj;
		if ( feduEmpNo == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.batch.dbio.dto.DSmpEmpTmp001Dto:\n");
		sb.append("\tfeduEmpNo: ");
