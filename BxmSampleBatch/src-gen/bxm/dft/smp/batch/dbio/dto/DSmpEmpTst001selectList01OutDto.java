...
/**
 * @Description 샘플부서번호 조회 출력 IO
 */
@XmlType(propOrder={"feduEmpNo", "feduEmpNm", "feduOccpNm", "feduMngrEmpNo", "feduHireDt", "feduPayAmt", "feduDeptNo"}, name="DSmpEmpTst001selectList01OutDto")
...
public class DSmpEmpTst001selectList01OutDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	@XmlTransient
	public static final String OMM_DESCRIPTION = "샘플부서번호 조회 출력 IO";
	...
	*******************************************************************************************************************************/
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.batch.dbio.dto.DSmpEmpTst001selectList01OutDto other= (bxm.dft.smp.batch.dbio.dto.DSmpEmpTst001selectList01OutDto)obj;
		if ( feduEmpNo == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.batch.dbio.dto.DSmpEmpTst001selectList01OutDto:\n");
		sb.append("\tfeduEmpNo: ");
