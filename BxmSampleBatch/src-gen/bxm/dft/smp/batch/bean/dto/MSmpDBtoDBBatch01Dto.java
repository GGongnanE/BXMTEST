...
/**
 * @Description 샘플부서번호 배치 IO 01
 */
@XmlType(propOrder={"feduEmpNo", "feduEmpNm", "feduOccpNm", "feduMngrEmpNo", "feduHireDt", "feduPayAmt", "feduDeptNo"}, name="MSmpDBtoDBBatch01Dto")
@XmlRootElement(name="MSmpDBtoDBBatch01Dto")
@SuppressWarnings("all")
public class MSmpDBtoDBBatch01Dto  implements IOmmObject, Predictable, FieldInfo  {

	private static final long serialVersionUID = 1922961554L;

	@XmlTransient
	public static final String OMM_DESCRIPTION = "샘플부서번호 배치 IO 01";
	...
	*******************************************************************************************************************************/
	...
	@Override
	public MSmpDBtoDBBatch01Dto clone(){
		try{
			MSmpDBtoDBBatch01Dto object= (MSmpDBtoDBBatch01Dto)super.clone();
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.batch.bean.dto.MSmpDBtoDBBatch01Dto other= (bxm.dft.smp.batch.bean.dto.MSmpDBtoDBBatch01Dto)obj;
		if ( feduEmpNo == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.batch.bean.dto.MSmpDBtoDBBatch01Dto:\n");
		sb.append("\tfeduEmpNo: ");
